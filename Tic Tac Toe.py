#Die entsprechende Datei heisst Tic Tac Toe.py.

#Autor*innen:
#Viviana Maria Ustica - Matrikelnummer: 372052
#Jan-Carlo Thomsen - Matrikelnummer: 366345
#Alexander Engel - Matrikelnummer: 374839

#Version: Python 3.9 (pythonProject) (letzte Änderung am 30.08.2021) - Abgabe bis zum 31.08.2021
#Quellen: #https://pythonbuch.com/gui.html
#eidesstattliche Erklaerung: die Aufgabe ist von uns selbststaendig verfasst/programmiert worden, und alle Quellen haben wir angegeben.
import tkinter
from tkinter import *
...
#Es wird geprüft ob O gewonnen hat
         if b1["text"] == "O" and b2["text"] == "O" and b3["text"] == "O":
            ...
            b3.config(bg="blue")
            winner = True
            messagebox.showinfo("Tic Tac Toe", "Schade, O hat gewonnen")
            disable_buttons()
